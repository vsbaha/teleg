...
main.add('Гдз').add('Нейросети').add('Помощь создателю')

main_admin = ReplyKeyboardMarkup(resize_keyboard=True)
main_admin.add('Гдз').add('Нейросети').add('Помощь создателю').add('Админ панель')
...
seven.add('Алгебра').add('Англиский').add('').add('Геометрия').add('Назад')
...
@dp.message_handler(text='Англиский')
async def eng(message: types.Message):
    await message.answer(f"Пока что не доступно. Если у вас есть гдз то напишите создателю")
